...
const insightModules: InsightModule[] = [
  ...
  },
  {
    ...
    status: "Live",
    route: "/clinical-insights/labs",
    body: "Recent abnormal labs and trending values, scored against deterministic critical and warning thresholds.",
    fhir: ["Observations", "Trends", "Reference bands"],
    outputs: ["Verdict", "Critical flags", "Trend reads"],
    readiness: "Strong current fit",
    recommended: true,
  },
  {
    ...
    body: "Per-medication affordability tier — specialty pharmacy, controlled substance, assistance candidate, or generic-likely.",
    fhir: ["Medications", "Drug classes"],
    outputs: ["Affordability verdict", "Per-med access path"],
    readiness: "Strong current fit",
    recommended: true,
  },
  {
  ...
  },
  {
    ...
    readiness: "Needs A1c / BP / lipid / BMI surface",
  },
  {
    id: "pregnancy",
    icon: HeartHandshake,
...
const defaultSelected = new Set(["chart-qa", "preop", "med-safety", "lab-explainer", "med-access", "trials"]);
