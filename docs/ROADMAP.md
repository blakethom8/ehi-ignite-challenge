...
The app is designed to deploy on a Hetzner CX21 VPS (~€4.85/mo) using Docker Compose + nginx + Let's Encrypt SSL. See `docs/architecture/deployment/DEPLOYMENT.md` for full setup.
